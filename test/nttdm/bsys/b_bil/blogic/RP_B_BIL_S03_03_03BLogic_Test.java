/**
 * @(#)RP_B_BIL_S03_03_03BLogic_Test.java
 * 
 * Billing System
 * 
 * Version 1.00
...
/**
 * Test Class for nttdm.bsys.b_bil.blogic.RP_B_BIL_S03_03_03BLogic
 * 
 * @author i-jankw
 * 
 */
public class RP_B_BIL_S03_03_03BLogic_Test extends AbstractUtilTest {

	RP_B_BIL_S03_03_03BLogic testObject = null;
	RP_B_BIL_S03_03_03Input param = null;
	...
	protected void setUpData() throws Exception {
		 ...
		 * init object
		 */
		testObject = new RP_B_BIL_S03_03_03BLogic();
		param = new RP_B_BIL_S03_03_03Input();
	...
	public void testExecute01() throws Exception {
		...
		String[][] dataM_CUST = {
				...
				{ "229743", "0123456789", "Duy Duong", "0123456789",
						...
						"0123456789", "0123456789", "PER", "0123456789", "",
						null, "" } };
	...
	public void testExecute02() throws Exception {
		...
		String[][] dataM_CUST = {
				{ "ID_CUST", "CUST_ACC_NO", "CUST_NAME", "CO_REGNO",
						...
						"SALES_FORCE_ACC_ID", "AFFILIATE_CODE", "ID_AUDIT",
						"MOBILE_NO" },
				{ "88543", "0123456789", "Duy Duong", "0123456789",
						"http://www.nttdata.com.vn",
						"duong.nguyen@nttdata.com.vn", "0123456789",
						"0123456789", "0", "0", "0", TEST_DAY_TODAY,
						TEST_DAY_TODAY, "USERFULL", "", "", null, "", "", "0",
	...
	public void testExecute03add() throws Exception {
		...
		String adrType = "BA";
		inputHeaderInfo.setAdrType(adrType);
		inputHeaderInfo.setContactType("229743");
		param.setBilHeaderInfo(inputHeaderInfo);
	...
	public void testExecute04add() throws Exception {
