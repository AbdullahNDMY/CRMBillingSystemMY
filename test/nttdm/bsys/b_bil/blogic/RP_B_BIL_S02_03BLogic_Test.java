...
public class RP_B_BIL_S02_03BLogic_Test extends AbstractUtilTest{
	RP_B_BIL_S02_03BLogic logic = null;
	RP_B_BIL_S02_03Input param = null;
	BillingSystemUserValueObject uvo = new BillingSystemUserValueObject();
	
	@Override
	protected void setUpData() throws Exception {
		logic = new RP_B_BIL_S02_03BLogic();
		logic.setQueryDAO(queryDAO);
		logic.setUpdateDAO(updateDAO);
		param = new RP_B_BIL_S02_03Input();
		uvo.setId_user("sysadmin");
		param.setIdRef("12345678901234567890");
		param.setUvo(uvo);
	}
	...
	public void testExecute1(){
		...
		String[][] tBilHData = {
				{ "ID_REF", "BILL_TYPE", "IS_MANUAL", "BILL_ACC", "DATE_REQ",
						...
						"ID_LOGIN", "ID_AUDIT" },
				{ "12345678901234567890", "IN", "0", "1", "2012-05-11", "CQ", "229743", "BA",
		...
		assertEquals("info.ERR2SC005", result.getMessages().get().next().getKey());
	}
	...
	public void testExecute2(){
		...
		String[][] tBilHData = {
				{ "ID_REF", "BILL_TYPE", "IS_MANUAL", "BILL_ACC", "DATE_REQ",
						...
						"PREPARED_BY", "DATE_CREATED", "DATE_UPDATED",
						"ID_LOGIN", "ID_AUDIT" },
				{ "12345678901234567890", "CN", "0", "1", "2012-05-11", "CQ", "229743", "BA",
						"PC", null, null, null, null, "bhchan", "30 Days",
						"MYR", "6", "0", "3500", "1000", TEST_DAY_TODAY, "0",
						"0", "0", "1", "USD", "3.124", "1120.36", "50", "1",
						TEST_DAY_TODAY, "joeykan", "0",
