...
/**
 * Test Class for nttdm.bsys.R_ACR.blogic.R_ACR_R01BLogic
 * 
 * @author Leonzh
 */
public class R_ACR_R01BLogic_Test extends AbstractUtilTest {

	private R_ACR_R01BLogic blogic;
	...
	public void testExecute01() {
		...
		String[][] dataM_USER_ACCESS = {
				{ "ID_USER", "ID_MODULE", "ID_SUB_MODULE", "ACCESS_TYPE",
						...
						"IS_DELETED", "ID_AUDIT" },
				{ "sysadmin", "R", "R-ACR", "2", TEST_DAY_TODAY,
		...
		R_ACR_R01Input input = new R_ACR_R01Input();
		...
		R_ACR_R01Output output = (R_ACR_R01Output) result.getResultObject();
	...
	public void testExecute02() {
		...
		String[][] dataM_USER_ACCESS = {
				{ "ID_USER", "ID_MODULE", "ID_SUB_MODULE", "ACCESS_TYPE",
						"DATE_CREATED", "DATE_UPDATED", "ID_LOGIN",
						"IS_DELETED", "ID_AUDIT" },
				{ "sysadmin", "R", "R-ACR", "1", TEST_DAY_TODAY,
						TEST_DAY_TODAY, "sysadmin", "0", null } };
		String[][] dataM_USER = {
                { "ID_USER", "USER_NAME", "ID_DIV", "ID_DEPT", "ID_ROLE",
                        "TEL_NO", "TEL_EXTNO", "DID_NO", "OFS_MOBILE_NO",
