...
/**
 * Test Class for nttdm.bsys.r_acr.blogic.R_ACR_R02BLogic
 * 
 * @author leonzh
 */
public class R_ACR_R02BLogic_Test extends AbstractUtilTest {

	private R_ACR_R02BLogic blogic;
	private R_ACR_R02Input input;
	private BLogicResult result;
	private R_ACR_R02Output output;
	...
	public void testExecute01() {
		...
		output = (R_ACR_R02Output) result.getResultObject();
		...
		List<HashMap<String, Object>> listAccrualReport = output
				.getListAccrualReport();
		HashMap<String, Object> accrualReport = listAccrualReport.get(0);
//		assertEquals("Duy Duong", accrualReport.get("CUST_NAME"));
//		assertEquals("2", accrualReport.get("SVC_LEVEL2").toString());
//		assertEquals("MYR", accrualReport.get("BILL_CURRENCY"));
//		assertEquals("01/2011", accrualReport.get("DATE_REQ"));
//		assertEquals("9", accrualReport.get("ITEM_AMT").toString());
	...
	public void testExecute02() {
		...
		HashMap<String, Object> accrualReport = listAccrualReport.get(0);
//		assertEquals("Duy Duong", accrualReport.get("CUST_NAME"));
//		assertEquals("0", accrualReport.get("SVC_LEVEL2").toString());
//		assertEquals("MYR", accrualReport.get("BILL_CURRENCY"));
//		assertEquals("01/2011", accrualReport.get("DATE_REQ"));
//		assertEquals("9", accrualReport.get("ITEM_AMT").toString());
