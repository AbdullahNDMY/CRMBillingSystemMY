/**
 * @(#)A_USR_S02_UpdateBLogic_Test.java
 * 
 * Billing System
 * 
 * Version 1.00
 ...
 *
 */
public class A_USR_S02_UpdateBLogic_Test extends AbstractUtilTest{
	
	private A_USR_S02_UpdateBLogic blogic02;
	...
	protected void setUpData() throws Exception {
		// init test object
		blogic02 = new A_USR_S02_UpdateBLogic();
	...
	public void testExecute() throws Exception{
		...
		// TODO: how to input user access right in the LIST
		...
		System.out.println("A_USR_S02 : Edit User : " + result.getResultString());
	}
