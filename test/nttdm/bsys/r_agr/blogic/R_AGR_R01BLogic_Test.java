...
/**
 * Test Class for nttdm.bsys.r_agr.blogic.R_AGR_R01BLogic
 * 
 * @author xycao
 */
public class R_AGR_R01BLogic_Test extends AbstractUtilTest {

	private R_AGR_R01BLogic blogic;
	...
	public void testExecute01() {
        ...
        String[][] dataM_USER_ACCESS = {
            { "ID_USER", "ID_MODULE", "ID_SUB_MODULE", "ACCESS_TYPE",
                    ...
                    "IS_DELETED", "ID_AUDIT" },
            { "sysadmin", "R", "R-AGR", "2", TEST_DAY_TODAY,
                    TEST_DAY_TODAY, "sysadmin", "0", AUDIT_VALUE } };
        String[][] dataM_USER = {
        ...
        R_AGR_R01Input input = new R_AGR_R01Input();
		...
		R_AGR_R01Output output = (R_AGR_R01Output) result
				.getResultObject();
