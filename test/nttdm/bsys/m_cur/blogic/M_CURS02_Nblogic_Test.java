 ...
 *
 */
public class M_CURS02_Nblogic_Test extends AbstractUtilTest{
	...
	public void testExecute() throws Exception{
		...
		arg0.setRate_date("30/4/2012");
		arg0.setCur_code("MYR");
		arg0.setRate_from("0.2345");
		arg0.setRate_to("2.3456");
				
		result = blogic02.execute(arg0);

		System.out.println("M_CUR_S02 : New Currency : " + result.getResultString());
