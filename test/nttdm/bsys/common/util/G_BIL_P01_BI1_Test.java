 ...
 * T_CUST_PLAN_H.BILL_INSTRUCT = 1(Yearly)
 * 
 * @author bench
 */
public class G_BIL_P01_BI1_Test extends G_BIL_P01_Test {

    private static String BILL_INSTRUCT = "1";
    
    /**
     * Case BI1_01: E/1 Yearly Custom Plan/FULLPERIOD_MODE(Start Service)
     * 
     * Condition:<br>
     * BILL_FROM = null<br>
     * BILL_TO = null<br>
     ...
     * BILL_TO = SVC_START + 1YEAR -1DAY<br>
     * 
     * @throws Exception
     */
    ...
    public void testExecuteBI101() throws Exception {
        ...
        String bill_to = TEST_DAY_NEXTYEAR_BEFOREYESTODAY;
        ...
        String[][] bacH = {
                ...
                { "1199999", ID_CUST, "CQ", DEF_CURRENCY, "1", "0", null, "RA",
        ...
        assertEquals("RA", tBilHlist[0].get("ADR_TYPE"));
        ...
        // When ZIP_CODE is null, ADDRESS4 only contains country name 
        assertEquals("Singapore", tBilHlist[0].get("ADDRESS4").toString().trim());
        assertEquals(null, tBilHlist[0].get("ZIP_CODE"));
        ...
        assertEquals("1200", tBilDlist[1].get("ITEM_UPRICE"));
        assertEquals("1200", tBilDlist[1].get("ITEM_AMT"));
        assertEquals("0", tBilDlist[1].get("ITEM_GST"));
        assertEquals("1200", tBilDlist[1].get("ITEM_EXPORT_AMT"));
        ...
        assertEquals("JOBNO1", tBilDlist[1].get("JOB_NO"));
    ...
    /**
     * Case BI1_02: E/1 Yearly Custom Plan/FULLPERIOD_MODE(In Service)
     * 
     * Condition:<br>
     * BILL_FROM not null<br>
     * BILL_TO current month's last day<br>
     * 
     * SVC_START = 1 year ago < SYSDATE <br>
     * SVC_END = null<br>
     * PLAN_STATUS = PS3<br>
     ...
     * 
     * Result:<br>
     * One data generated in T_BIL_H/2 data in T_BIL_D<br>
     * T_BAC_H.TOTAL_AMT_DUE += BillAmount
     * T_CUST_PLAN_H.PLAN_STATUS = "PS3"<br>
     * T_CUST_PLAN_D.SERVICES_STATUS = "PS3"<br>
     * BILL_FROM = last BILL_TO +1<br>
     * BILL_TO = BILL_FROM + 1YEAR -1DAY<br>
     * 
     * No record in T_BIL_S<br>
     * 
     * @throws Exception
     */
    @SuppressWarnings("unchecked")
    public void testExecuteBI102() throws Exception {
        String plan_status = "PS3";
        String service_status = "PS3";
    ...
    /**
     * Case BI1_03: E/1 Yearly Custom Plan/PS7(Terminated)
     * 
     * Condition:<br>
     * BILL_FROM not null<br>
     * BILL_TO = yesterday = SVC_END<br>
     * 
     * SVC_START = 10 years ago < SYSDATE <br>
     * SVC_END = Yesterday<br>
     * PLAN_STATUS = PS3<br>
     ...
     * T_BAC_D.SERVICES_STATUS = "PS7"<br>
     * T_BAC_D.IS_RECURRING = 0<br>
     * 
     * @throws Exception
     */
    @SuppressWarnings("unchecked")
    public void testExecuteBI103() throws Exception {
        String plan_status = "PS3";
        String service_status = "PS7";
        String service_start = "2001-01-01";
        String service_end = TEST_DAY_YESTERDAY;
        String last_bill_from = TEST_DAY_LASTYEAR_TODAY;
        String last_bill_to = TEST_DAY_YESTERDAY;
        String bill_from = TEST_DAY_LASTYEAR_TODAY;
        String bill_to = TEST_DAY_YESTERDAY;
        ...
        Date billTo = format.parse(tBacD[0].get("BILL_TO").toString());
        assertEquals(bill_to, format.format(billTo));
        // assert T_BAC_D.IS_RECURRING = 0
        assertEquals("0", tBacD[0].get("IS_RECURRING").toString());
    ...
    /**
     * Case BI1_04: E/1 Yearly Custom Plan/PS7(Terminated)
     * 
     * Condition:<br>
     * BILL_FROM not null<br>
     * BILL_TO = yesterday = SVC_END<br>
     ...
     */
    @SuppressWarnings("unchecked")
    public void testExecuteBI104() throws Exception {
        String plan_status = "PS3";
        String service_status = "PS7";
        String service_start = "2001-01-01";
        String service_end = TEST_DAY_YESTERDAY;
    ...
    /**
     * Case BI1_05: E/1 Yearly Custom Plan/PRORATE_SVCEND
     * 
     * Condition:<br>
     * BILL_FROM not null<br>
     * BILL_TO = 2011-05-05<br>
     * 
     * SVC_START = 10 years ago < SYSDATE <br>
     * SVC_END = 2011-07-07<br>
     * T_CUST_PLAN_H.PLAN_STATUS = PS3<br>
     * T_CUST_PLAN_D.SERVICES_STATUS = PS3<br>
     ...
     * nDay = 2
     * 
     * Amount = (Total_Amount/nMode) * (nMonth + nDay / p)
     * 
     * Result:<br>
     * One data generated in T_BIL_H/2 data in T_BIL_D<br>
     * BILL_FROM = 2011-05-06<br>
     * BILL_TO = 2011-07-07<br>
     * PLAN_STATUS = "PS3"<br>
     * SERVICES_STATUS = "PS3"<br>
     * IS_RECURRING = 0<br>
     * 
     ...
     */
    @SuppressWarnings("unchecked")
    public void testExecuteBI105() throws Exception {
        String plan_status = "PS3";
        String service_status = "PS3";
        String service_start = "2001-01-01";
        String service_end = "2011-07-07";
        String last_bill_from = TEST_DAY_LASTYEAR_TODAY;
        String last_bill_to = "2011-05-05";
        String bill_from = "2011-05-06";
        String bill_to = "2011-07-07";

        // Update CB_AUTO_OFFSET to NULL in order to not update TOTAL_AMT_DUE.
        HashMap<String, Object> params = new HashMap<String, Object>();
        params.put("SET_VALUE", null);
        params.put("ID_SET", "CB_AUTO_OFFSET");
        params.put("SET_SEQ", "1");
        super.updateDAO.execute("TEST.G_BIL_P01.UPDATE.SQL002", params);
        ...
        assertEquals("0", tBilHlist[0].get("GST_PERCENT"));
        assertEquals("0", tBilHlist[0].get("GST_AMOUNT"));
        assertEquals("413.33", tBilHlist[0].get("BILL_AMOUNT"));
        assertEquals("0", tBilHlist[0].get("PAID_AMOUNT"));
        assertEquals(null, tBilHlist[0].get("LAST_PAYMENT_DATE"));
        assertEquals("0", tBilHlist[0].get("IS_SETTLED"));
        assertEquals("1", tBilHlist[0].get("IS_SINGPOST"));
        ...
        assertEquals(DEF_CURRENCY, tBilHlist[0].get("EXPORT_CUR"));
        assertEquals("1", tBilHlist[0].get("CUR_RATE"));
        assertEquals("413.33", tBilHlist[0].get("EXPORT_AMOUNT"));
        assertEquals(null, tBilHlist[0].get("FIXED_FOREX"));
        assertEquals("0", tBilHlist[0].get("NO_PRINTED"));
        assertEquals(null, tBilHlist[0].get("DATE_PRINTED"));
        assertEquals(null, tBilHlist[0].get("USER_PRINTED"));
        ...
        assertEquals(null, tBilDlist[0].get("ITEM_NO"));
        assertEquals("1", tBilDlist[0].get("ITEM_QTY"));
        assertEquals("413.33", tBilDlist[0].get("ITEM_UPRICE"));
        assertEquals("413.33", tBilDlist[0].get("ITEM_AMT"));
        assertEquals("0", tBilDlist[0].get("ITEM_GST"));
        assertEquals("0", tBilDlist[0].get("ITEM_EXPORT_AMT"));
        assertEquals("0", tBilDlist[0].get("APPLY_GST"));
        assertEquals("0", tBilDlist[0].get("IS_DISPLAY"));
        ...
        assertEquals("206.67", tBilDlist[1].get("ITEM_UPRICE"));
        assertEquals("413.33", tBilDlist[1].get("ITEM_AMT"));
        assertEquals("0", tBilDlist[1].get("ITEM_GST"));
        assertEquals("413.33", tBilDlist[1].get("ITEM_EXPORT_AMT"));
        assertEquals("0", tBilDlist[1].get("APPLY_GST"));
        assertEquals("1", tBilDlist[1].get("IS_DISPLAY"));
        assertEquals("1", tBilDlist[1].get("ID_CUST_PLAN"));
        assertEquals("1", tBilDlist[1].get("ID_CUST_PLAN_GRP"));
    ...
    /**
     * Case BI1_06: E/1 Yearly Custom Plan/FULLPERIOD_MODE(2 Billing Period)
     * 
     * Condition:<br>
     * BILL_FROM not null<br>
     * BILL_TO current month's last day<br>
     ...
     * 
     * Result:<br>
     * 2 data generated in T_BIL_H/6 data in T_BIL_D<br>
     * PLAN_STATUS = "PS3"<br>
     * BILL_FROM = last BILL_TO +1<br>
     * BILL_TO = BILL_FROM + 1YEAR -1DAY<br>
     * T_BAC_H.TOTAL_AMT_DUE -= BillAmount<br>
     * 
     * @throws Exception
     */
    @SuppressWarnings("unchecked")
    public void testExecuteBI106() throws Exception {
        String plan_status = "PS3";
        String service_status = "PS3";
        String service_start = "2001-02-05";
        String service_end = null;
        String last_bill_from = "2009-02-05";
        String last_bill_to = "2010-02-04";
        String bill_from = "2010-02-05";
        String bill_to = "2011-02-04";
        String bill_from2 = "2011-02-05";
        String bill_to2 = "2012-02-04";
        ...
        String[][] bacH = {
                { "ID_BILL_ACCOUNT", "ID_CUST", "PAYMENT_METHOD",
                        ...
                        "DATE_UPDATED", "ID_LOGIN", "FIXED_FOREX", "ID_AUDIT" },
                { "1199999", ID_CUST, "CQ", DEF_CURRENCY, "1", "0", null, "BA",
                        "PC", "24000", "0", TEST_DAY_TODAY, TEST_DAY_TODAY,
                        SYS_ADMIN, null, null } };
        super.insertData("T_BAC_H", bacH);
        ...
        assertEquals("0", tBilHlist[0].get("GST_PERCENT"));
        assertEquals("0", tBilHlist[0].get("GST_AMOUNT"));
        assertEquals("7200", tBilHlist[0].get("BILL_AMOUNT")); 
        assertEquals("0", tBilHlist[0].get("PAID_AMOUNT"));
        assertEquals(null, tBilHlist[0].get("LAST_PAYMENT_DATE"));
        assertEquals("0", tBilHlist[0].get("IS_SETTLED"));
        assertEquals("1", tBilHlist[0].get("IS_SINGPOST"));
        ...
        assertEquals(DEF_CURRENCY, tBilHlist[0].get("EXPORT_CUR"));
        assertEquals("1", tBilHlist[0].get("CUR_RATE"));
        assertEquals("7200", tBilHlist[0].get("EXPORT_AMOUNT"));
        assertEquals(null, tBilHlist[0].get("FIXED_FOREX"));
        assertEquals("0", tBilHlist[0].get("NO_PRINTED"));
        assertEquals(null, tBilHlist[0].get("DATE_PRINTED"));
        assertEquals(null, tBilHlist[0].get("USER_PRINTED"));
        ...
        //("2400", tBilHlist[1].get("BILL_AMOUNT"));
        //assertEquals("2400", tBilHlist[1].get("EXPORT_AMOUNT"));
        ...
        assertEquals(null, tBilDlist[0].get("ITEM_NO"));
        assertEquals("1", tBilDlist[0].get("ITEM_QTY"));
        assertEquals("2400", tBilDlist[0].get("ITEM_UPRICE"));
        assertEquals("2400", tBilDlist[0].get("ITEM_AMT"));
        assertEquals("0", tBilDlist[0].get("ITEM_GST"));
        assertEquals("0", tBilDlist[0].get("ITEM_EXPORT_AMT"));
        assertEquals("0", tBilDlist[0].get("APPLY_GST"));
        assertEquals("0", tBilDlist[0].get("IS_DISPLAY"));
        ...
        assertEquals("1200", tBilDlist[2].get("ITEM_UPRICE"));
        assertEquals("1200", tBilDlist[2].get("ITEM_AMT"));
        assertEquals("0", tBilDlist[2].get("ITEM_GST"));
        assertEquals("1200", tBilDlist[2].get("ITEM_EXPORT_AMT"));
        ...
        assertEquals("JOBNO2", tBilDlist[2].get("JOB_NO"));
        ...
        assertEquals("2400", tBilDlist[3].get("ITEM_UPRICE"));
        assertEquals("2400", tBilDlist[3].get("ITEM_AMT"));
        assertEquals(null, tBilDlist[3].get("JOB_NO"));
        assertEquals("5", tBilDlist[4].get("ITEM_ID"));
        assertEquals("1", tBilDlist[4].get("ITEM_LEVEL"));
        assertEquals("1", tBilDlist[4].get("ITEM_QTY"));
        assertEquals("1200", tBilDlist[4].get("ITEM_UPRICE"));
        assertEquals("1200", tBilDlist[4].get("ITEM_AMT"));
        assertEquals("JOBNO1", tBilDlist[4].get("JOB_NO"));
        assertEquals("6", tBilDlist[5].get("ITEM_ID"));
        assertEquals("1", tBilDlist[5].get("ITEM_LEVEL"));
        assertEquals("1", tBilDlist[5].get("ITEM_QTY"));
        assertEquals("1200", tBilDlist[5].get("ITEM_UPRICE"));
        assertEquals("1200", tBilDlist[5].get("ITEM_AMT"));
        assertEquals("JOBNO2", tBilDlist[5].get("JOB_NO"));
        
        for (int i = 3; i< 6; i++) {
            Date billfrom2 = format.parse(tBilDlist[i].get("BILL_FROM").toString());
            assertEquals(bill_from2, format.format(billfrom2));
            Date billTo2 = format.parse(tBilDlist[i].get("BILL_TO").toString());
            assertEquals(bill_to2, format.format(billTo2));
        }
        ...
        Map<String, Object>[] tBacD = super.select("T_BAC_D",
                "ID_CUST_PLAN_GRP='1' AND ID_BILL_ACCOUNT='1199999'", null);
        Date billfrom = format.parse(tBacD[0].get("BILL_FROM").toString());
        assertEquals("2012-02-05", format.format(billfrom));
        Date billTo = format.parse(tBacD[0].get("BILL_TO").toString());
        assertEquals("2013-02-04", format.format(billTo));
        assertEquals("1", tBacD[0].get("IS_RECURRING"));

        // assert T_BAC_H.TOTAL_AMT_DUE updated
        Map<String, Object>[] tBacH = super.select("T_BAC_H",
                "ID_BILL_ACCOUNT='1199999'", null);
        assertEquals("16800", tBacH[0].get("TOTAL_AMT_DUE")); 
    ...
    /**
     * Case BI1_07: E/2 Yearly Custom Plan/FULLPERIOD_MODE(In Service)
     * 
     * Condition:<br>
     * PLAN_STATUS = PS3<br>
     * BILL_INSTRUCT = 1: 12 (Yearly)<br>
     ...
     * 
     * Result:<br>
     * One data generated in T_BIL_H/4 data in T_BIL_D<br>
     * CUST_PLAN_STATUS = "PS3"<br>
     * 
     * @throws Exception
     */
    @SuppressWarnings("unchecked")
    public void testExecuteBI107() throws Exception {
        String plan_status = "PS3";
        String service_status = "PS3";
        String service_start = TEST_DAY_LASTYEAR_YESTERDAY;
        String service_end = null;
        ...
        String bill_from = TEST_DAY_YESTERDAY;
        String bill_to = TEST_DAY_NEXTYEAR_BEFOREYESTODAY;
        String service_start2 = TEST_DAY_TODAY;
        String service_end2 = null;
        String last_bill_from2 = null;
        String last_bill_to2 = null;
        String bill_from2 = TEST_DAY_TODAY;
        String bill_to2 = TEST_DAY_NEXTYEAR_YESTERDAY;
        ...
        String[][] custPlanD = {
                ...
                { "1", ID_CUST_PLAN, service_status, service_start,
                        service_end, "1", "0", null, null, "M", null, "U",
                        "30", "0", null, "0", TEST_DAY_TODAY, TEST_DAY_TODAY,
                        SYS_ADMIN, null },
                { "2", ID_CUST_PLAN_2, service_status, service_start2,
                        service_end2, "1", "0", null, null, "M", null, "U",
                        "30", "0", null, "0", TEST_DAY_TODAY, TEST_DAY_TODAY,
                        SYS_ADMIN, null } };
        super.insertData("T_CUST_PLAN_D", custPlanD);
        this.updateBILL_DESC("1");
        ...
        String[][] bacD = {
                { "ID_BILL_ACCOUNT", "ID_CUST_PLAN_GRP", "ID_CUST_PLAN",
                        ...
                        "ID_LOGIN", "ID_AUDIT" },
                { "1199999", "1", "1", "1", "1", last_bill_from, last_bill_to,
                        null, null, null, null, "ACM1", "30Days",
                        TEST_DAY_TODAY, TEST_DAY_TODAY, SYS_ADMIN, null },
                { "1199999", "2", "2", "1", "1", last_bill_from2, last_bill_to2,
                        null, null, null, null, "ACM2", "31Days",
                        TEST_DAY_TODAY, TEST_DAY_TODAY, SYS_ADMIN, null } };
        super.insertData("T_BAC_D", bacD);
        ...
        assertEquals("BA", tBilHlist[0].get("ADR_TYPE"));
        assertEquals("PC", tBilHlist[0].get("CONTACT_TYPE"));
        assertEquals("ACM1;ACM2", tBilHlist[0].get("ID_CONSULT"));
        assertEquals("30Days;31Days", tBilHlist[0].get("TERM"));
        ...
        billfrom1 = format.parse(tBilDlist[1].get("BILL_FROM").toString());
        assertEquals(bill_from, format.format(billfrom1));
        billTo1 = format.parse(tBilDlist[1].get("BILL_TO").toString());
        assertEquals(bill_to, format.format(billTo1));
        ...
        // T_BIL_D[3] is blank when T_CUST_PLAN_D.IS_DISPLAY_DESC=0
        assertEquals("3", tBilDlist[2].get("ITEM_ID"));
        assertEquals("0", tBilDlist[2].get("ITEM_LEVEL"));
        assertEquals(null, tBilDlist[2].get("ITEM_NO"));
        assertEquals("1", tBilDlist[2].get("ITEM_QTY"));
        assertEquals("1200", tBilDlist[2].get("ITEM_UPRICE"));
        assertEquals("1200", tBilDlist[2].get("ITEM_AMT"));
        assertEquals("0", tBilDlist[2].get("ITEM_GST"));
        ...
        assertEquals("2", tBilDlist[2].get("ID_CUST_PLAN"));
        assertEquals("2", tBilDlist[2].get("ID_CUST_PLAN_GRP"));
        ...
        Date billfrom2 = format.parse(tBilDlist[2].get("BILL_FROM").toString());
        assertEquals(bill_from2, format.format(billfrom2));
        
        Date billTo2 = format.parse(tBilDlist[2].get("BILL_TO").toString());
        assertEquals(bill_to2, format.format(billTo2));
        ...
        // T_BIL_D[3] is generated from T_CUST_PLAN_LINK
        assertEquals("4", tBilDlist[3].get("ITEM_ID"));
        assertEquals("1", tBilDlist[3].get("ITEM_LEVEL"));
        assertEquals("1", tBilDlist[3].get("ITEM_QTY"));
        assertEquals("1200", tBilDlist[3].get("ITEM_UPRICE"));
        assertEquals("1200", tBilDlist[3].get("ITEM_AMT"));
        assertEquals("0", tBilDlist[3].get("ITEM_GST"));
        assertEquals("1200", tBilDlist[3].get("ITEM_EXPORT_AMT"));
        assertEquals("0", tBilDlist[3].get("APPLY_GST"));
        assertEquals("1", tBilDlist[3].get("IS_DISPLAY"));
        assertEquals("2", tBilDlist[3].get("ID_CUST_PLAN"));
        assertEquals("2", tBilDlist[3].get("ID_CUST_PLAN_GRP"));
        assertEquals("2", tBilDlist[3].get("ID_CUST_PLAN_LINK"));
        assertEquals("1", tBilDlist[3].get("SVC_LEVEL1"));
        assertEquals("2", tBilDlist[3].get("SVC_LEVEL2"));
        
        billfrom2 = format.parse(tBilDlist[3].get("BILL_FROM").toString());
        assertEquals(bill_from2, format.format(billfrom2));
        
        billTo2 = format.parse(tBilDlist[3].get("BILL_TO").toString());
        assertEquals(bill_to2, format.format(billTo2));

        assertEquals("JOBNO5", tBilDlist[3].get("JOB_NO"));
        ...
        assertEquals(bill_to, format.format(billTo));
        assertEquals("1", tBacD[0].get("IS_RECURRING"));
        billfrom = format.parse(tBacD[1].get("BILL_FROM").toString());
        assertEquals(bill_from2, format.format(billfrom));
        billTo = format.parse(tBacD[1].get("BILL_TO").toString());
        ...
        Map<String, Object>[] tBacH = super.select("T_BAC_H",
                "ID_BILL_ACCOUNT='1199999'", null);
        assertEquals("3600", tBacH[0].get("TOTAL_AMT_DUE"));
