/**
 * @(#)RP_E_MEX_GR1DownloadBLogic_Test.java
 * 
 * Billing System NTTS
 * 
 * Version 1.00
...
/**
 * Test Class for nttdm.bsys.e_mex.blogic.RP_E_MEX_GR1DownloadBLogic
 * 
 * @author leonzh
 */
public class RP_E_MEX_GR1DownloadBLogic_Test extends AbstractUtilTest {

	private RP_E_MEX_GR1DownloadBLogic blogic;
	private RP_E_MEX_GR1DownloadInput input;
	...
	protected void setUpData() throws Exception {
		blogic = new RP_E_MEX_GR1DownloadBLogic();
		blogic.setQueryDAO(queryDAO);
		input = new RP_E_MEX_GR1DownloadInput();
	}
