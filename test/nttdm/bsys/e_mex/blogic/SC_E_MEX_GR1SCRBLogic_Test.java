/**
 * @(#)SC_E_MEX_GR1SCRBLogic_Test.java
 * 
 * Billing System NTTS
 * 
 * Version 1.00
...
/**
 * Test Class for nttdm.bsys.e_mex.blogic.SC_E_MEX_GR1SCRBLogic
 * 
 * @author leonzh 
 */
public class SC_E_MEX_GR1SCRBLogic_Test extends AbstractUtilTest {

	private static String SYSTEMDATE;
	private SC_E_MEX_GR1SCRBLogic blogic;
	...
	protected void setUpData() throws Exception {
		blogic = new SC_E_MEX_GR1SCRBLogic();
	...
	/**
	 * 
	 * Case 1:test by scheduler setting is null
	 * 
	 * Condition: <br>
	 * setting = null <br>
	...
	public void testExecute01() throws Exception {
		...
		super.deleteAllData("T_GIR_EXP_HD");
		...
		assertEquals(null, output.get("runtimeType"));
	...
	/**
	 * 
	 * Case 2:test by scheduler setting isn't null and scheduleStatus is 1
	 * 
	 * Condition: <br>
	 * setting != null <br>
	...
	public void testExecute02() throws Exception {
		...
		assertEquals("G_GIR_P01", output.get("ID_BATCH_TYPE"));
		...
		assertEquals("223", oneHistory.get("ID_GIR_EXP_BATCH").toString()
				.trim());
	...
	/**
	 * 
	 * Case 3:test by scheduler setting isn't null and scheduleStatus is 0
	 * 
	 * Condition: <br>
	 * setting != null <br>
	 * countHistory = new Integer(1) <br>
	...
	/**
	 * 
	 * Case 4:test throw Exception and catch the Excpetion
	 * 
	 * Condition: <br>
	 * queryDAO = null <br>
	 * 
