/**
 * @(#)SC_E_MEX_CT1SCRBLogic_Test.java
 * 
 * Billing System NTTS
 * 
 * Version 1.00
...
/**
 * Test Class for nttdm.bsys.e_mex.blogic.SC_E_MEX_CT1SCRBLogic
 * 
 * @author leonzh
 */ 
public class SC_E_MEX_CT1SCRBLogic_Test extends AbstractUtilTest {

	private static String SYSTEMDATE;
	private SC_E_MEX_CT1SCRBLogic blogic;
	...
	protected void setUpData() throws Exception {
		blogic = new SC_E_MEX_CT1SCRBLogic();
	...
	public void testExecute02() throws Exception {
		...
		assertEquals("G_CIT_P01", output.get("ID_BATCH_TYPE"));
		...
		assertEquals("223", oneHistory.get("ID_CIT_EXP_BATCH").toString()
				.trim());
