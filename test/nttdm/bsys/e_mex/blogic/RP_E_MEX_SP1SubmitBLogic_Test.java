/**
 * @(#)RP_E_MEX_SP1SubmitBLogic_Test.java
 * 
 * Billing System NTTS
 * 
 * Version 1.00
...
/**
 * Test Class for nttdm.bsys.e_mex.blogic.RP_E_MEX_SP1SubmitBLogic
 * 
 * @author leonzh
 */
public class RP_E_MEX_SP1SubmitBLogic_Test extends AbstractUtilTest {

	private RP_E_MEX_SP1SubmitBLogic blogic;
	private RP_E_MEX_SP1SubmitInput input;
	...
	protected void setUpData() throws Exception {
		blogic = new RP_E_MEX_SP1SubmitBLogic();
		blogic.setQueryDAO(queryDAO);
		blogic.setUpdateDAO(updateDAO);
		input = new RP_E_MEX_SP1SubmitInput();
	}
	...
	public void testExecute01() {
		...
		RP_E_MEX_SP1SubmitOutput output = null;
		...
		output = (RP_E_MEX_SP1SubmitOutput) result.getResultObject();
