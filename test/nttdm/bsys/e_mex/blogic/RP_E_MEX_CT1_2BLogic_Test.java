/**
 * @(#)RP_E_MEX_CT1_2BLogic_Test.java
 * 
 * Billing System NTTS
 * 
 * Version 1.00
...
/**
 * Test Class for nttdm.bsys.e_mex.blogic.RP_E_MEX_CT1_2BLogic
 * 
 * @author leonzh
 */
public class RP_E_MEX_CT1_2BLogic_Test extends AbstractUtilTest {

	private RP_E_MEX_CT1_2BLogic blogic;
	private BLogicResult result;
	private RP_E_MEX_CT1_2Input input;
	private RP_E_MEX_CT1_2Output output;
	...
	protected void setUpData() throws Exception {
		blogic = new RP_E_MEX_CT1_2BLogic();
		blogic.setQueryDAO(queryDAO);

		result = new BLogicResult();
		input = new RP_E_MEX_CT1_2Input();
		output = new RP_E_MEX_CT1_2Output();
	}
	...
	public void testExecute01() {
		...
		output = (RP_E_MEX_CT1_2Output) result.getResultObject();
		...
		assertEquals("G_CIT_P01", logReview.get("ID_BATCH_TYPE").toString());
