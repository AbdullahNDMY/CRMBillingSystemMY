...
public class R_BAC_R03BLogic_Test extends AbstractUtilTest{
	
	R_BAC_R03BLogic logic = null;
	R_BAC_R03Input input = null;
	BLogicResult result = null;
	SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
	
	@Override
	protected void setUpData() throws Exception {
		logic = new R_BAC_R03BLogic();
		input = new R_BAC_R03Input();
	}
	...
	public void testExecute01(){
		...
		assertEquals(true, result.getResultObject() instanceof DownloadFile);
		assertEquals(true, ((DownloadFile)result.getResultObject()).getName().endsWith("csv"));
	}
}
