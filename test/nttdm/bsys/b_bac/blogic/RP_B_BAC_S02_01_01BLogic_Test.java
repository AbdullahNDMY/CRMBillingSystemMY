/**
 * @(#)RP_B_BAC_S02_01_01BLogic_Test.java
 * 
 * Billing System NTTS
 * 
 * Version 1.00
...
/**
 * Test Class for nttdm.bsys.b_bac.blogic.RP_B_BAC_S02_01_01BLogic
 * 
 * @author leonzh 
 */
public class RP_B_BAC_S02_01_01BLogic_Test extends AbstractUtilTest {

	private RP_B_BAC_S02_01_01BLogic blogic;
	private RP_B_BAC_S02_01_01Input input;
	private RP_B_BAC_S02_01_01Output output;
	...
	protected void setUpData() throws Exception {
		blogic = new RP_B_BAC_S02_01_01BLogic();
		blogic.setQueryDAO(queryDAO);
		blogic.setUpdateDAO(updateDAO);
		input = new RP_B_BAC_S02_01_01Input();
		this.deleteAllData("M_CUST");
	}

	/**
	 * 
	 * Case 1:test normal situation one by selected one checkbox
	 * 
	 * Condition: <br>
	 * Payment Method = "Cash"("CA") <br>
	 * Sub.ID = "203" <br>
	 ...
	 * Sub Table SVC Level1 = "ANY CATE1" <br>
	 * Sub Table SVC Level2 = "S1" <br>
	 * 
	 */
	public void testExecute01() {
		...
		String[][] tBacDData = {
				...
				{ "203", "1100154", "1", null, null, null, null, null,
						...
						"2011-09-05", "sysadmin", null, null, "203" } };
		...
		String[][] tCustPlanDData = {
				{ "ID_CUST_PLAN_GRP", "ID_CUST_PLAN", "SERVICES_STATUS",
						...
						"IS_DELETED", "DATE_CREATED", "DATE_UPDATED",
						"ID_LOGIN", "ID_AUDIT" },
				{ "203", "203", "PS1", "2011-05-11", "2011-08-06", "1", "1",
		...
		param.put("ID_CUST_PLAN_GRP", "203");
		...
		String[][] tCustPlanLinkData = {
				...
				{ "23", "203", null, "12", "12", "144", "GBIL-001", "1191",
		...
		output = (RP_B_BAC_S02_01_01Output) result.getResultObject();

		assertEquals("CA", output.getInputHeaderInfo().getPaymentMethod());
	...
	/**
	 * 
	 * Case 2:test normal situation one by selected one checkbox
	 * 
	 * Condition: <br>
	 * Payment Method = "Cheque"("CQ") <br>
	 * Sub.ID = "203" <br>
	...
	public void testExecute02() {
		...
		String[][] tBacH = {
				{ "ID_BILL_ACCOUNT", "ID_CUST", "PAYMENT_METHOD",
						...
						"ID_LOGIN", "FIXED_FOREX", "ID_AUDIT", "IS_SINGPOST",
						"TOTAL_AMT_DUE" },
				{ "1100154", "21", "CQ", "MYR", "0", null, "BA", "PC", "0",
						"2011-01-18 12:43:28", "2011-01-18 12:43:28", "DM",
						null, null, "1", "0" } };
		super.insertData("T_BAC_H", tBacH);
		...
		assertEquals("CQ", output.getInputHeaderInfo().getPaymentMethod());
		List<HashMap<String, Object>> newListPlanInfo = output
				.getListPlanInfo();
		assertEquals("203", newListPlanInfo.get(0).get("ID_CUST_PLAN"));
	...
	/**
	 * 
	 * Case 3:test normal situation one by more than one checkbox is selected
	 * 
	 * Condition: <br>
	 * Payment Method one = "Cash"("CA") <br>
	 * Payment Method two = "Cash"("CA") <br>
	 * 
	 * Result: <br>
	 * Payment Method = "Cash"("CA") <br>
	 * 
	...
	public void testExecute03() {
		...
		String[][] tBacH = {
				...
				{ "1100154", "21", "CA", "MYR", "0", null, "BA", "PC", "0",
						"2011-01-18 12:43:28", "2011-01-18 12:43:28", "DM",
						null, null, "1", "0" },
				{ "1100155", "21", "QB", "MYR", "0", null, "BA", "PC", "0",
						"2011-01-18 12:43:28", "2011-01-18 12:43:28", "DM",
						null, null, "1", "0" } };
		super.insertData("T_BAC_H", tBacH);
		...
		String[][] tCustPlanHData = {
				{ "ID_CUST_PLAN", "ID_CUST", "PLAN_STATUS", "PLAN_TYPE",
						...
						"IS_DISPLAY_EXP_AMT", "IS_DELETED", "DATE_CREATED",
						"DATE_UPDATED", "ID_LOGIN", "ID_AUDIT" },
				{ "43", "21", "PS5", "NP", null, "IN", null, "1100155",
						"1", "1", "356", "5", "CA", "KHR", "BIF", "12", "0",
						"0", "2011-08-02 16:14:17", "2011-09-05", "sysadmin",
						null },
				{ "62", "21", "PS5", "NP", null, "IN", null, "1100155",
						"1", "1", "356", "5", "CA", "KHR", "BIF", "12", "0",
						"0", "2011-08-02 16:14:17", "2011-09-05", "sysadmin",
						null } };
		super.insertData("T_CUST_PLAN_H", tCustPlanHData);
		...
		T_BAC_H inputHeaderInfo2 = output.getInputHeaderInfo();
		assertEquals("CA", inputHeaderInfo2.getPaymentMethod());
	}

	/**
	 * 
	 * Case 4:test normal situation one by more than one checkbox is selected
	 * 
	 * Condition: <br>
	 * Payment Method one = "Cash"("CA") <br>
	 * Payment Method two = "Cheque"("CQ") <br>
	 * 
	 * Result: <br>
	 * Payment Method = null <br>
	 * 
	 */
	public void testExecute04() {
		...
		String[][] tBacH = {
				...
				{ "1100154", "21", "CA", "MYR", "0", null, "BA", "PC", "0",
						"2011-01-18 12:43:28", "2011-01-18 12:43:28", "DM",
						null, null, "1", "0" },
				{ "1100155", "21", "CA", "MYR", "0", null, "BA", "PC", "0",
						"2011-01-18 12:43:28", "2011-01-18 12:43:28", "DM",
						null, null, "1", "0" } };
		super.insertData("T_BAC_H", tBacH);
