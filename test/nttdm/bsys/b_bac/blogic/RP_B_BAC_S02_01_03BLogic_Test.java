...
public class RP_B_BAC_S02_01_03BLogic_Test extends AbstractUtilTest {

	private RP_B_BAC_S02_01_03BLogic blogic;
	private RP_B_BAC_S02_01_03Input input;
	...
	protected void setUpData() throws Exception {
		blogic = new RP_B_BAC_S02_01_03BLogic();
		blogic.setQueryDAO(queryDAO);
		blogic.setUpdateDAO(updateDAO);

		input = new RP_B_BAC_S02_01_03Input();
		...
		String[][] tCustPlanLinkData = {
				...
				{ "23", "43", null, "12", "12", "144", "GBIL-001", "1191",
						null, "sd sdf ssdff ds sdf ", null, null, "268", "311",
						"EX", "5", "23", "1", "0", "2011-08-02 16:14:35",
						"2011-08-10 16:31:43", "USERFULL", AUDIT_VALUE, "S" },
				{ "24", "62", null, "12", "12", "144", null, "1191",
						null, "sd sdf ssdff ds sdf ", null, null, "268", "311",
						"EX", "5", "23", "1", "0", "2011-08-02 16:14:35",
