 ...
 *
 */
public class M_BNKS02neBlogic_Test extends AbstractUtilTest{
	
	private M_BNKS02neBlogic blogic02;
	private M_BNKS02neInput param;
	private M_BNKS02neOutput output;
	BLogicResult result;
	...
	protected void setUpData() throws Exception {
		...
		blogic02 = new M_BNKS02neBlogic();
		blogic02.setQueryDAO(queryDAO);
		blogic02.setUpdateDAO(updateDAO);
		
		param = new M_BNKS02neInput();
		output= new M_BNKS02neOutput();
	...
	public void testExecute() throws Exception{
		...
		output = (M_BNKS02neOutput) result.getResultObject();
		System.out.println("Page Status : " + output.getPage_status());
		System.out.println("M_BNK_S02 : New Bank : " + result.getResultString());
