...
/**
 * Test Class for nttdm.bsys.r_rrr.blogic.R_RRR_R02BLogic
 * 
 * @author leonzh
 */
public class R_RRR_R02BLogic_Test extends AbstractUtilTest {

	private R_RRR_R02BLogic blogic;
	private R_RRR_R02Input input;
	private BLogicResult result;
	private R_RRR_R02Output output;
...
//		input.setTbxYearTo("");
		...
		output = (R_RRR_R02Output) result.getResultObject();
		...
		List<HashMap<String, Object>> listRefundReport = output
				.getListRefundReport();
		HashMap<String, Object> refundReport = listRefundReport.get(0);
		assertEquals("12/04/2011", refundReport.get("DATE_TRANS"));
		assertEquals("Duy Duong", refundReport.get("CUST_NAME"));
		assertEquals("ABC", refundReport.get("AFFILIATE_CODE"));
		assertEquals("1", refundReport.get("ID_REF"));
		assertEquals("Bank-In Slip No.", refundReport.get("REFERENCE2"));
		assertEquals("8888", refundReport.get("COM_ACCT_NAME"));
		assertEquals("CQ", refundReport.get("PMT_METHOD"));
		assertEquals("MYR", refundReport.get("CUR_CODE"));
		assertEquals("3500", refundReport.get("BILL_AMOUNT").toString());
		assertEquals("51", refundReport.get("AMT_PAID").toString());
...
//		input.setTbxYearTo("");
	 ...
	 * Result: <br>
	 * totalRow = 0 <br>
	 * result.getMessages() != null <br>
	 * result.getResultString() = "success" <br>
	 * 
	 */
	public void testExecute11() {
		input.setStartIndex(new Integer(0));
		input.setTbxPaidDateFrom("01/05/2011");
		input.setTbxPaidDateTo("");
		input.setTbxCustomerName("");
		input.setTbxAffiliateCod("");
		input.setCboPaymentMetho("");
		input.setCboCurrency("");
		...
		BLogicMessage message = messages.get().next();
		assertEquals("info.ERR2SC002", message.getKey());

		Iterator<String> groups = messages.getGroup();
		assertTrue(groups.hasNext());
		assertEquals("org.apache.struts.action.GLOBAL_MESSAGE", groups.next());

		assertEquals("success", result.getResultString());
	}
//	/**
//	 * TbxYearFr is not number
//	 */
//	public void testExecute12add() {
//		input.setStartIndex(new Integer(0));
//		input.setCboPaidMonthFr("");
//		input.setTbxYearFr("2000/");
//		input.setCboPaidMonthTo("");
//		input.setTbxYearTo("");
//		input.setTbxCustomerName("");
//		input.setTbxAffiliateCod("");
...
//
//		result = blogic.execute(input);
//		assertEquals("errors.ERR1SC011",result.getErrors().get().next().getKey());
//	}
//	/**
//	 * TbxYearFr > TbxYearTo
//	 */
//	public void testExecute13add() {
//		input.setStartIndex(new Integer(0));
//		input.setCboPaidMonthFr("");
//		input.setTbxYearFr("2012");
//		input.setCboPaidMonthTo("");
//		input.setTbxYearTo("2000");
//		input.setTbxCustomerName("");
//		input.setTbxAffiliateCod("");
//		input.setCboPaymentMetho("");
//		input.setCboCurrency("");
...
//
//		result = blogic.execute(input);
//		assertEquals("errors.ERR1SC013",result.getErrors().get().next().getKey());
//	
//	}
}
