...
public class G_ALT_P05_Thread implements Runnable{
	...
	public G_ALT_P05_Thread(QueryDAO query, UpdateDAO update,BillingSystemUserValueObject ov)
	{
		queryDAO=query;
		updateDAO=update;
		uvo=ov;	
	...
	public void run() {
		G_ALT_P05 gp05 = new G_ALT_P05(queryDAO,updateDAO);
		gp05.execute(uvo);
		//recode who run
        Integer idbatch=gp05.getIdBatch();
        recodeWhoRun(uvo.getId_user(),"SD",idbatch);
