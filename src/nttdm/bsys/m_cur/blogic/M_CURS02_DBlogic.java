...
public class M_CURS02_DBlogic extends AbstractM_CURBLogic{
	/**
	 * <div>UpdateDAO</div>
	 */
	 ...
	 * <div>UPDATE_SQL</div>
	 */
	private static final String UPDATE_SQL = "UPDATE.M_CUR.SQL002";
	/**
	 * <div>SAVE_ERROR_MSG</div>
	 */
	static final String SAVE_ERROR_MSG = "info.ERR2SC006";
	private static final String SAVE_SUCCESS_MSG = "info.ERR2SC005";
	...
	public BLogicResult execute(M_CURInput arg0) {
		...
		try{
			...
			//arg0.setRate_date(arg0.getDate_created());
