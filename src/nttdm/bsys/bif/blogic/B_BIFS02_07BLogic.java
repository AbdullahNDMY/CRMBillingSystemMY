 ...
 * @author duongnld
 */
public class B_BIFS02_07BLogic extends AbstractB_BIFS02_07BLogic {
	...
	public BLogicResult execute(B_BIFS02Input input) {
		...
		try {
			...
			if (B_BIFS02Input.APPROVAL_ACTION.equals(input.getAction())
					|| B_BIFS02Input.REJECT_ACTION.equals(input.getAction())) {
				...
				if (B_BIFS02Input.REJECT_ACTION.equals(input.getAction())) {
