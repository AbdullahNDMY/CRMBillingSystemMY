 ...
 * @author duongnld
 */
public class B_BIFS03_06BLogic extends AbstractB_BIFS03_06BLogic {
	...
	private static final String UPDATE_CORPORATE_INFO = "UPDATE.B_BIF.S03_06.SQL001";
	...
	public BLogicResult execute(B_BIFS03Input input) {
		...
		try {
			...
			if ("BOP-CN".equals(input.getSectionGroup()) && "1".equals(input.getIsSave())) {
