/**
 * @(#)M_PPM_S02CheckError2BLogic.java
 * 
 * Billing System
 * 
 * Version 1.00
...
import nttdm.bsys.m_ppm.dto.M_PPM_S02CheckError2Input;
import nttdm.bsys.m_ppm.dto.M_PPM_S02CheckError2Output;
 ...
 *
 */
public class M_PPM_S02CheckErrorSavePlanBLogic implements BLogic<M_PPM_S02CheckError2Input> {

    private QueryDAO queryDAO;
    
    public BLogicResult execute(M_PPM_S02CheckError2Input params) {
        BLogicResult result = new BLogicResult();
        BLogicMessages errors = new BLogicMessages();
        M_PPM_S02CheckError2Output output = new M_PPM_S02CheckError2Output();
        ...
        if(plantype.equals("S")){
            result.setResultString("success_service");
        }
        //Add Option
        else{
