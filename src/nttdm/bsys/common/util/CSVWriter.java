...
public class CSVWriter {
     ...
     *
     */
    public void writeAllFullNumber(List<String[]> list) {
        for (int i=0; i<list.size();i++)
        {
            String[] nextLine = list.get(i);
            writeNextFullNumber(nextLine);
        }
    }
     ...
     *            entry.
     */
    public void writeNextFullNumber(String[] nextLine) {
        ...
        for (int i = 0; i < nextLine.length; i++) {
            ...
            if (nextElement == null) {
                ...
                try {
                    new BigDecimal(StringUtils.trim(nextElement));
                    sb.append("=");
                } catch (Exception e) {
                }
            }
