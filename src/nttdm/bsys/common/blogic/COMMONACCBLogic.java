 ...
 *
 */
public class COMMONACCBLogic implements BLogic<HashMap<String, Object>> {
    ...
    public BLogicResult execute(HashMap<String, Object> params) {
        ...
        if (subscriptInfoMap!=null) {
            output.put("preAccessAccount", CommonUtils.toString(subscriptInfoMap.get("ACCESS_ACCOUNT")));
        }
