...
public class E_EMLInput implements Serializable{
	...
	private Integer pdfCheckSize;
	private Integer emailCheckSize;
	private Integer sameEmailCheckSize;
	private Integer peopleCheckSize;
	...
	/**
	 * @return the pdfCheckSize
	 */
	public Integer getPdfCheckSize() {
		return pdfCheckSize;
	}
	/**
	 * @param pdfCheckSize the pdfCheckSize to set
	 */
	public void setPdfCheckSize(Integer pdfCheckSize) {
		this.pdfCheckSize = pdfCheckSize;
	}
	/**
	 * @return the emailCheckSize
	 */
	public Integer getEmailCheckSize() {
		return emailCheckSize;
	}
	/**
	 * @param emailCheckSize the emailCheckSize to set
	 */
	public void setEmailCheckSize(Integer emailCheckSize) {
		this.emailCheckSize = emailCheckSize;
	}
	/**
	 * @return the sameEmailCheckSize
	 */
	public Integer getSameEmailCheckSize() {
		return sameEmailCheckSize;
	}
	/**
	 * @param sameEmailCheckSize the sameEmailCheckSize to set
	 */
	public void setSameEmailCheckSize(Integer sameEmailCheckSize) {
		this.sameEmailCheckSize = sameEmailCheckSize;
	}
	/**
	 * @return the idRefs
	 */
	...
	/**
	 * @return the peopleCheckSize
	 */
	public Integer getPeopleCheckSize() {
		return peopleCheckSize;
	}
	/**
	 * @param peopleCheckSize the peopleCheckSize to set
	 */
	public void setPeopleCheckSize(Integer peopleCheckSize) {
		this.peopleCheckSize = peopleCheckSize;
	}
	/**
	 * @return the uvo
	 */
