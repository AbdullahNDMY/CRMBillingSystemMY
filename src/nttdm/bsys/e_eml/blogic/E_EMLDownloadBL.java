...
public class E_EMLDownloadBL extends DownloadAction{
	...
	protected StreamInfo getStreamInfo(ActionMapping mapping, ActionForm form,
		...
		Map<String, Object> doc = queryDAO.executeForMap("E_EML.selectFileName", idDoc);
        String fileName = (String) doc.get("FILENAME");	
        String fileLocation = (String) doc.get("FILELOCATION");
