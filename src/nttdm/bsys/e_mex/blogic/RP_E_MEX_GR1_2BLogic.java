...
import nttdm.bsys.e_mex.blogic.AbstractRP_E_MEX_GR1_2BLogic;
 ...
 * @author thinhtv
 */
public class RP_E_MEX_GR1_2BLogic extends AbstractRP_E_MEX_GR1_2BLogic {
	 ...
	 */
	public BLogicResult execute(RP_E_MEX_GR1_2Input param) {
		BLogicResult result = new BLogicResult();
		RP_E_MEX_GR1_2Output outputDTO = new RP_E_MEX_GR1_2Output();
