...
public class M_CSTR04Input implements Serializable {

	/**
	 * <div>serialVersionUID</div>
	 */
	private static final long serialVersionUID = 729577611724417090L;
	/**
	 * <div>mode</div>
	 */
     ...
     * <div>co_email_cc</div>
     */
    private String co_email_cc = null;
	...
	public void setManagerPrimary(String managerPrimary) {
		this.managerPrimary = managerPrimary != null ? managerPrimary.trim() : managerPrimary;
	}
	...
	public void setManagerSecondary(String managerSecondary) {
		this.managerSecondary = managerSecondary != null ? managerSecondary.trim() : managerSecondary;
	}
	...
	public String getCo_email_cc() {
        return co_email_cc;
    }

    public void setCo_email_cc(String co_email_cc) {
        this.co_email_cc = co_email_cc;
    }

    public String getPc_contact_name() {
		return this.pc_contact_name;
	}
    ...
    /**
     * @param bc_email_cc the bc_email_cc to set
     */
    ...
    /**
     * @param oc_email_cc the oc_email_cc to set
     */
    ...
    /**
     * @param tc_email_cc the tc_email_cc to set
     */
    ...
    /**
     * @param pc_email_cc the pc_email_cc to set
     */
	...
	public CustomerDto getCustomerDto(){
		...
		cust.setAdr_type(this.adr_type);
		cust.setBa_adr_line1(this.ba_adr_line1);
		cust.setBa_adr_line2(this.ba_adr_line2);
		cust.setBa_adr_line3(this.ba_adr_line3);
		cust.setBa_country_id(this.ba_country_id);
		cust.setBa_zip_code(this.ba_zip_code);
		cust.setBc_contact_name(this.bc_contact_name);
		cust.setBc_designation(this.bc_designation);
		cust.setBc_did_no(this.bc_did_no);
		cust.setBc_email(this.bc_email);
		cust.setBc_email_cc(this.bc_email_cc);
		cust.setBc_fax_no(this.bc_fax_no);
		cust.setBc_mobile_no(this.bc_mobile_no);
		cust.setBc_tel_no(this.bc_tel_no);
		cust.setBill_type(this.bill_type);
		cust.setCa_adr_line1(this.ca_adr_line1);
		cust.setCa_adr_line2(this.ca_adr_line2);
		cust.setCa_adr_line3(this.ca_adr_line3);
		cust.setCa_country_id(this.ca_country_id);
		cust.setCa_zip_code(this.ca_zip_code);
		cust.setCo_email(this.co_email);
		cust.setCo_email_cc(this.co_email_cc);
		cust.setCo_fax_no(this.co_fax_no);
		cust.setCo_regno(this.co_regno);
		cust.setCo_tel_no(this.co_tel_no);
		cust.setCo_website(this.co_website);
		cust.setContact_type(this.contact_type);
		cust.setCust_acc_no(this.cust_acc_no);
		cust.setCust_name(this.cust_name);
		cust.setGboc_acc_no(this.gboc_acc_no);
		cust.setGin(this.gin);
		cust.setId_cust(this.id_cust);
		cust.setIdc(this.idc);
		cust.setInter_comp(this.inter_comp);
		cust.setIsp(this.isp);
		cust.setMode(this.mode);
		cust.setOc_contact_name(this.oc_contact_name);
		cust.setOc_designation(this.oc_designation);
		cust.setOc_did_no(this.oc_did_no);
		cust.setOc_email(this.oc_email);
		cust.setOc_email_cc(this.oc_email_cc);
		cust.setOc_fax_no(this.oc_fax_no);
		cust.setOc_mobile_no(this.oc_mobile_no);
		cust.setOc_tel_no(this.oc_tel_no);
		cust.setOthers_ref_no(this.others_ref_no);
		cust.setPc_contact_name(this.pc_contact_name);
		cust.setPc_designation(this.pc_designation);
		cust.setPc_did_no(this.pc_did_no);
		cust.setPc_email(this.pc_email);
		cust.setPc_email_cc(this.pc_email_cc);
		cust.setPc_fax_no(this.pc_fax_no);
		cust.setPc_mobile_no(this.pc_mobile_no);
		cust.setPc_tel_no(this.pc_tel_no);
		cust.setPrint_statement(this.print_statement);
		cust.setRa_adr_line1(this.ra_adr_line1);
		cust.setRa_adr_line2(this.ra_adr_line2);
		cust.setRa_adr_line3(this.ra_adr_line3);
		cust.setRa_country_id(this.ra_country_id);
		cust.setRa_zip_code(this.ra_zip_code);
		cust.setSim(this.sim);
		cust.setTa_adr_line1(this.ta_adr_line1);
		cust.setTa_adr_line2(this.ta_adr_line2);
		cust.setTa_adr_line3(this.ta_adr_line3);
		cust.setTa_country(this.ta_country);
		cust.setTa_country_id(this.ta_country_id);
		cust.setTa_zip_code(this.ta_zip_code);
		cust.setTc_contact_name(this.tc_contact_name);
		cust.setTc_designation(this.tc_designation);
		cust.setTc_did_no(this.tc_did_no);
		cust.setTc_email(this.tc_email);
		cust.setTc_email_cc(this.tc_email_cc);
		cust.setTc_fax_no(this.tc_fax_no);
		cust.setTc_mobile_no(this.tc_mobile_no);
		cust.setTc_tel_no(this.tc_tel_no);
		cust.setUvo(this.uvo);
		cust.setUvoObject(this.uvoObject);
		
		cust.setSalutation(this.salutation);
		cust.setSales_force_acc_id(this.sales_force_acc_id);
		cust.setCust_birth_date(this.cust_birth_date);
		cust.setCust_id_no(this.cust_id_no);
		cust.setCustomer_type(this.customer_type);
		cust.setHome_fax_no(this.home_fax_no);
		cust.setHome_tel_no(this.home_tel_no);
		cust.setAffiliate_ntt(this.affiliate_ntt);
		cust.setMobile_no(this.mobile_no);
		cust.setManagerPrimary(this.managerPrimary.replaceAll(";", ""));
		cust.setManagerSecondary(this.managerSecondary.replaceAll(";", ""));
		cust.setCompany_category(this.company_category);
		cust.setCompany_sub_category(this.company_sub_category);
		cust.setCompany_bank_info(this.company_bank_info);
		cust.setEnd_user(this.end_user);
		cust.setCategory_enableFlg(this.category_enableFlg);
		cust.setSubCategory_enableFlg(this.subCategory_enableFlg);
		cust.setBankInfo_enableFlg(this.bankInfo_enableFlg);
		//Add by MiffyAn start
		cust.setCompany_type(this.company_type);
		cust.setCompany_enableFlg(this.company_enableFlg);
		//Add by MiffyAn end
		//billing address2
		cust.setBa_adr2_line1(this.ba_adr2_line1);
		cust.setBa_adr2_line2(this.ba_adr2_line2);
		cust.setBa_adr2_line3(this.ba_adr2_line3);
		cust.setBa_zip_code2(this.ba_zip_code2);
		cust.setBa_country2(this.ba_country2);
		cust.setBa_country2_id(this.ba_country2_id);
		//billing address3
		cust.setBa_adr3_line1(this.ba_adr3_line1);
        cust.setBa_adr3_line2(this.ba_adr3_line2);
        cust.setBa_adr3_line3(this.ba_adr3_line3);
        cust.setBa_zip_code3(this.ba_zip_code3);
        cust.setBa_country3(this.ba_country3);
        cust.setBa_country3_id(this.ba_country3_id);
        //billing address4
        cust.setBa_adr4_line1(this.ba_adr4_line1);
        cust.setBa_adr4_line2(this.ba_adr4_line2);
        cust.setBa_adr4_line3(this.ba_adr4_line3);
        cust.setBa_zip_code4(this.ba_zip_code4);
        cust.setBa_country4(this.ba_country4);
        cust.setBa_country4_id(this.ba_country4_id);
        //billing contact2
        cust.setBc2_contact_name(this.bc2_contact_name);
        cust.setBc2_designation(this.bc2_designation);
        cust.setBc2_did_no(this.bc2_did_no);
        cust.setBc2_email_to(this.bc2_email_to);
        cust.setBc2_email_cc(this.bc2_email_cc);
        cust.setBc2_fax_no(this.bc2_fax_no);
        cust.setBc2_mobile_no(this.bc2_mobile_no);
        cust.setBc2_tel_no(this.bc2_tel_no);
        //billing contact3
        cust.setBc3_contact_name(this.bc3_contact_name);
        cust.setBc3_designation(this.bc3_designation);
        cust.setBc3_did_no(this.bc3_did_no);
        cust.setBc3_email_to(this.bc3_email_to);
        cust.setBc3_email_cc(this.bc3_email_cc);
        cust.setBc3_fax_no(this.bc3_fax_no);
        cust.setBc3_mobile_no(this.bc3_mobile_no);
        cust.setBc3_tel_no(this.bc3_tel_no);
        //billing contact4
        cust.setBc4_contact_name(this.bc4_contact_name);
        cust.setBc4_designation(this.bc4_designation);
        cust.setBc4_did_no(this.bc4_did_no);
        cust.setBc4_email_to(this.bc4_email_to);
        cust.setBc4_email_cc(this.bc4_email_cc);
        cust.setBc4_fax_no(this.bc4_fax_no);
        cust.setBc4_mobile_no(this.bc4_mobile_no);
        cust.setBc4_tel_no(this.bc4_tel_no);
