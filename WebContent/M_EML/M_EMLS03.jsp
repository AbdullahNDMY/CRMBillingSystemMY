...
<head>
	...
	<style>
		.mask{position:absolute;width:100%;height:100%;z-index:1;filter:alpha(opacity=0.5);opacity:0.5;background:#cccccc}
	</style>
...
<body onload="initload()">
	...
	<ts:form action="/M_EMLS02Save">
		<html:hidden property="isSaveFlg" styleClass="isSaveFlg"/>
		<html:hidden property="modelFlg" styleClass="modelFlg"/>
		<html:hidden property="code" styleClass="code"/>
		<input type="hidden" id="userAccess" name="userAccess" value="<%=accessRight%>" />
		...
		<logic:notEqual value="2" name="accessRightBean">
			<tr>
				...
				<td width="30%"><html:text name="m_eml02_Form" property="code" styleClass="QCSTextBox" style="width:100px;" disabled="true" maxlength="5"></html:text>
				</td>
			...
			<tr>
				...
				<td width="30%"><html:text name="m_eml02_Form" property="description" styleClass="QCSTextBox" style="width:800px;" disabled="true" maxlength="100"></html:text>
				</td>
			</tr>
			<tr>
				<td width="15%"><bean:message key="screen.m_emls01.title.from_display_name"/><bean:message key="screen.m_eml.colon"/> 
				</td>
				<td width="30%"><html:text name="m_eml02_Form" property="display_name" styleClass="QCSTextBox" style="width:800px;" disabled="true" maxlength="100"></html:text>
				</td>
			</tr>
			<tr>
				<td width="15%"><bean:message key="screen.m_emls01.title.subject"/><bean:message key="screen.m_eml.colon"/> 
				</td>
				<td width="30%"><html:text name="m_eml02_Form" property="subject" styleClass="QCSTextBox" style="width:800px;" disabled="true" maxlength="100"></html:text>
				</td>
			</tr>
			<tr>
				<td width="15%"><bean:message key="screen.m_emls02.label.Attach"/><bean:message key="screen.m_eml.colon"/> 
				</td>
				<td width="30%"><html:text name="m_eml02_Form" property="attachpass" styleClass="QCSTextBox" style="width:800px;" disabled="true" maxlength="20"></html:text>
				</td>
			</tr>
			<tr>
				<td width="15%"><bean:message key="screen.m_emls02.label.zipFilename"/><bean:message key="screen.m_eml.colon"/> 
				</td>
				<td width="30%"><html:text name="m_eml02_Form" property="zipFilename" styleClass="QCSTextBox" style="width:800px;" disabled="true" maxlength="50"></html:text>
				</td>
			</tr>
			<tr>
				<td width="15%"><bean:message key="screen.m_emls02.label.attachment1"/><bean:message key="screen.m_eml.colon"/> 
				</td>
				<td width="30%"><html:text name="m_eml02_Form" property="attactmen1" styleClass="QCSTextBox" style="width:800px;" disabled="true" maxlength="50"></html:text>
				</td>
			</tr>
			<tr>
				<td width="15%"><bean:message key="screen.m_emls02.label.attachment2"/><bean:message key="screen.m_eml.colon"/> 
				</td>
				<td width="30%"><html:text name="m_eml02_Form" property="attactmen2" styleClass="QCSTextBox" style="width:800px;" disabled="true" maxlength="50"></html:text>
				</td>
			</tr>
			<tr>
				<td width="15%"><bean:message key="screen.m_emls02.label.attachment3"/><bean:message key="screen.m_eml.colon"/> 
				</td>
				<td width="30%"><html:text name="m_eml02_Form" property="attactmen3" styleClass="QCSTextBox" style="width:800px;" disabled="true" maxlength="50"></html:text>
				</td>
			</tr>
			<tr>
				<td width="15%"><bean:message key="screen.m_emls02.label.attachment4"/><bean:message key="screen.m_eml.colon"/> 
				</td>
				<td width="30%"><html:text name="m_eml02_Form" property="attactmen4" styleClass="QCSTextBox" style="width:800px;" disabled="true" maxlength="50"></html:text>
				</td>
			</tr>
			<tr>
				<td width="15%"><bean:message key="screen.m_emls01.title.cc"/><bean:message key="screen.m_eml.colon"/> 
				</td>
				<td width="30%"><html:text name="m_eml02_Form" property="alwaysCc" styleClass="QCSTextBox" style="width:800px;" disabled="true" maxlength="50"></html:text>
				</td>
			</tr>
			<tr>
				...
				<div class="mask" style="width:800px;"></div>
			...
			<tr>
				...
				<td width="30%">
					<nested:textarea property="remark" styleClass="remark" style="width:801px;overflow-y:hidden" readonly="readonly" styleId="remarkArea"/>
				</td>
			</tr>
			</logic:notEqual>
			...
			<tr>
				...
				<td width="30%"><html:text name="m_eml02_Form" property="alwaysCc" styleClass="QCSTextBox" style="width:800px;" maxlength="50"></html:text>
				</td>
			</tr>
			<tr>
				<td width="15%" valign="top"><bean:message key="screen.m_emls02.label.content"/><bean:message key="screen.m_eml.colon"/> 
