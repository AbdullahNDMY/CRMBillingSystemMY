...
<body class="popup" onload="POPAPWClickInit();">
<ts:form action="/POPUP_COMMON_DSP.do?event=forward_changeAccessPasswordSave">
<html:hidden name="_popupCommonForm" property="idSubInfo" styleId="idSubInfo"/>
<html:hidden name="_popupCommonForm" property="accessAccount" styleId="accessAccount"/>
...
<table border="0" cellpadding="0" cellspacing="2" class="popup" style="margin-top:20px;margin-left:5px;margin-bottom:5px;margin-left:20px;">
	<tr>
		...
		<td>
		    Please note that old access password will be expired and new access password<br/>
	...
	<tr>
	    <td colspan="2" style="padding-left:50px;padding-top:15px;">
	       <input type="button" name="btnYes" value="Save" onclick="return POPAPWClickSave();" style="width:70px;"/>
