...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/M_PPM/js/m_ppm_s06a.js"></script>
...
<nested:iterate property="services">
	<fieldset id="planInfo">
		<legend style="color: #4876FF"><bean:message key="screen.m_ppms02.subplan"/></legend>
		...
		<table cellpadding="2" cellspacing="2" class="serviceHeader">
			<tr>
				<td><span id="typeName"><bean:message key="screen.m_ppms02.svcName"/></span>&nbsp;<span class="mandatory"><bean:message key="screen.m_ppms02.label_mandatory"/></span></td>
			    <td colspan="2">
...
<span style="display:none;" id="ERR4SC017_GSTANDCategory"><bean:message key="info.ERR4SC017" arg0="All Sub plan / Option's ${_m_ppmFormS02.map.taxWord} settings and Category / Service settings are not same"  arg1="${_m_ppmFormS02.map.taxWord}"/></span>
