...
if (jscalendarDom){
	var html = "";
    html += "<div onclick='jscalendarBShow=true' id='calendar'  class='" + jscalendarThemePrefix + "-div-style'>";
    html += "<table width='220' class='" + jscalendarThemePrefix + "-table-style'>";
    html += "<tr class='" + jscalendarThemePrefix + "-title-background-style'>";
    html += "<td><table width='218'><tr><td class='" + jscalendarThemePrefix + "-title-style'><span id='caption'></span></td>";
    html += "<td align=right>";
    html += "<a href='javascript:jscalendarHideCalendar();'>";
    html +="<img src='" + jscalendarImgDir + jscalendarThemePrefix + 
        "-close.gif' width='15' height='13' border='0' onmousemove='window.status=\"\"'>";
    html +="</a></td></tr></table></td></tr><tr>";
    html +="<td class='" + jscalendarThemePrefix + "-body-style'><span id='content'></span></td></tr>";
    html +="<tr class='" + jscalendarThemePrefix + "-today-style'>";
    html +="<td class='" + jscalendarThemePrefix + "-today-lbl-style'>";
    html +="<span id='lblToday'></span></td></tr>";
    html +="</table></div><div id='selectMonth' class='" + jscalendarThemePrefix + "-div-style'></div>";
    html +="<div id='selectYear' class='" + jscalendarThemePrefix + "-div-style'></div>";
...
function jscalendarInit(){  
    if (!jscalendarNs4){
        ...
        document.getElementById("lblToday").innerHTML = 
            ...
            localtoday + "</a>   "+
            "<a href='javascript:jscalendarDeleteSelectedDate();'>&nbsp;delete&nbsp;</a>";
...
function jscalendarDeleteSelectedDate() {
    var sTmp;
