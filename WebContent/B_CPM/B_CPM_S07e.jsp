...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/B_CPM/js/b_cpm_s07.js"></script>
	<title></title>
</head>
<body id="b" onload="changewidth();preparebody();" onunload="closeEvt('${pageContext.request.contextPath}/B_CPM/B_CPM_S02ViewBL.do?customerPlan.idCustPlan=${_B_CPM_S07Form.map.idCustPlan}')">
<ts:form action="/B_CPM_S07DSP" >
	...
	<html:hidden name="_B_CPM_S07Form" property="ID_MAIL"/>
	<html:hidden name="_B_CPM_S07Form" property="MAILACC"/>
	<html:hidden name="_B_CPM_S07Form" property="MAILBOX_QTY"/>
	<html:hidden name="_B_CPM_S07Form" property="VIRUS_SCAN"/>
	<html:hidden name="_B_CPM_S07Form" property="ANTI_SPAM"/>
	<html:hidden name="_B_CPM_S07Form" property="JUNK_MGT"/>
	<input type="hidden" id="loadPerentPgeFlg" value=""/>
			...
			<td style="border-top: 3px solid white">
				<table cellpadding="0" cellspacing="0" width="100%" >
					...
					<tr>
						...
						<td align="center"><html:checkbox name="_B_CPM_S07Form" property="AUTO_MAIL_ACC" styleId="AUTO_MAIL_ACC" value="1" onclick="checkMailAccount(this)"/></td>
						<td align="center"><html:checkbox name="_B_CPM_S07Form" property="AUTO_MAILBOX_QTY" value="1" styleId="AUTO_MAILBOX_QTY" onclick="checkOptions(this,'OPT_MAILBOX_QTY')"/></td>
						<td align="center"><html:checkbox name="_B_CPM_S07Form" property="AUTO_VIRUS_SCAN" value="1" styleId="AUTO_VIRUS_SCAN" onclick="checkOptions(this,'OPT_VIRUS_SCAN')"/></td>
						<td align="center"><html:checkbox name="_B_CPM_S07Form" property="AUTO_ANTI_SPAM" value="1" styleId="AUTO_ANTI_SPAM" onclick="checkOptions(this,'OPT_ANTI_SPAM')"/></td>
						<td align="center"><html:checkbox name="_B_CPM_S07Form" property="AUTO_JUNK_MGT" value="1" styleId="AUTO_JUNK_MGT" onclick="checkOptions(this,'OPT_JUNK_MGT')"/></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td style="border-top: 3px solid white;border-bottom: 3px solid white">
				<table cellpadding="0" cellspacing="0" width="100%" >
					...
					<tr>
						...
						<td align="center"><html:text name="_B_CPM_S07Form" property="OPT_BASE_QTY" styleId="OPT_BASE_QTY" style="width:50px" maxlength="10"/></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
								...
								<table cellpadding="0" cellspacing="0" width="100%">
									...
									<c:if test="${index != (subPlanLen - 1)}">
										<tr>
											...
											<td style="border-top: 1px solid #CFCFCF;" align="center"><html:radio name="_B_CPM_S07Form" property="OPT_ADDT_OPTION" value="${subPlan.ID_CUST_PLAN_LINK}"/></td>
											<td style="border-top: 1px solid #CFCFCF;" align="center"><html:radio name="_B_CPM_S07Form" property="OPT_MAILBOX_QTY" value="${subPlan.ID_CUST_PLAN_LINK}"/></td>
											<td style="border-top: 1px solid #CFCFCF;" align="center"><html:radio name="_B_CPM_S07Form" property="OPT_VIRUS_SCAN" value="${subPlan.ID_CUST_PLAN_LINK}"/></td>
											<td style="border-top: 1px solid #CFCFCF;" align="center"><html:radio name="_B_CPM_S07Form" property="OPT_ANTI_SPAM" value="${subPlan.ID_CUST_PLAN_LINK}"/></td>
											<td style="border-right: 1px solid #CFCFCF;border-top: 1px solid #CFCFCF;" align="center"><html:radio name="_B_CPM_S07Form" property="OPT_JUNK_MGT" value="${subPlan.ID_CUST_PLAN_LINK}"/></td>
										</tr>
									</c:if>
									<c:if test="${index == (subPlanLen - 1)}">
										<tr>
											...
											<td style="border-top: 1px solid #CFCFCF;border-bottom: 1px solid #CFCFCF;" align="center"><html:radio name="_B_CPM_S07Form" property="OPT_ADDT_OPTION" value="${subPlan.ID_CUST_PLAN_LINK}"/></td>
											<td style="border-top: 1px solid #CFCFCF;border-bottom: 1px solid #CFCFCF;" align="center"><html:radio name="_B_CPM_S07Form" property="OPT_MAILBOX_QTY" value="${subPlan.ID_CUST_PLAN_LINK}"/></td>
											<td style="border-top: 1px solid #CFCFCF;border-bottom: 1px solid #CFCFCF;" align="center"><html:radio name="_B_CPM_S07Form" property="OPT_VIRUS_SCAN" value="${subPlan.ID_CUST_PLAN_LINK}"/></td>
											<td style="border-top: 1px solid #CFCFCF;border-bottom: 1px solid #CFCFCF;" align="center"><html:radio name="_B_CPM_S07Form" property="OPT_ANTI_SPAM" value="${subPlan.ID_CUST_PLAN_LINK}"/></td>
											<td style="border-right: 1px solid #CFCFCF;border-top: 1px solid #CFCFCF;border-bottom: 1px solid #CFCFCF;" align="center"><html:radio name="_B_CPM_S07Form" property="OPT_JUNK_MGT" value="${subPlan.ID_CUST_PLAN_LINK}"/></td>
		</tr>
									</c:if>
								</table>
		</logic:iterate>
	...
	<table class="buttonGroup" cellpadding="0" cellspacing="0">
		<tr>
			<td><logic:equal name="_B_CPM_S07Form" property="accessType" value="2">
					<ts:submit property="forward_save" style="width:70px" onclick="return saveCheck();"><bean:message key="screen.b_cpm.s07.button.save"/></ts:submit>&nbsp;&nbsp;&nbsp;
				</logic:equal>
	...
	<input type="hidden" id="ERR4SC015" value='<bean:message key="info.ERR4SC015"/>'/>
	<input type="hidden" id="ERR1SC098" value='<bean:message key="errors.ERR1SC098"/>'/>
	<input type="hidden" id="ERR1SC099" value='<bean:message key="errors.ERR1SC099" arg0="Base quantity" arg1="Base quantity"/>'/>
	<input type="hidden" id="ERR1SC088" value='<bean:message key="errors.ERR1SC088" arg0="Mail Account Base Qty"/>'/>
</ts:form>
</body>
</html>