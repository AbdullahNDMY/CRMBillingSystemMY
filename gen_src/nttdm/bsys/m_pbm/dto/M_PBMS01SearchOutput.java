 ...
 * @author khaln
 */
public class M_PBMS01SearchOutput implements Serializable {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -1050419209810751947L;
     ...
     * 
     */
	private List<java.util.Map<String, Object>> cust_plan_group;

	/**
     * 
     */
	private List<LabelValueBean> cboSvcGrp;
	...
	/**
	 * cust_plan_group を取得する
	 * 
	 * @return cust_plan_group
	 */
	public List<java.util.Map<String, Object>> getCust_plan_group() {
		return cust_plan_group;
	}

	/**
	 * cust_plan_group を設定する
	 * 
	 * @param cust_plan_group
	 */
	public void setCust_plan_group(
			List<java.util.Map<String, Object>> cust_plan_group) {
		this.cust_plan_group = cust_plan_group;
	}
	 ...
	 * @return cboSvcGrp
	 */
	public List<LabelValueBean> getCboSvcGrp() {
		return cboSvcGrp;
	}
	 ...
	 * @param cboSvcGrp
	 */
	public void setCboSvcGrp(List<LabelValueBean> cboSvcGrp) {
		this.cboSvcGrp = cboSvcGrp;
	}
